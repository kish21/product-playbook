...
| 2 Dev | `/contracts, /tickets` | Typed models/schemas/migrations BEFORE logic | `#Contracts` lists typed models/migrations (applies); boundary units/scale agreed; **versioning**; **PII + tenant + idempotency keys**; API contracts documented |

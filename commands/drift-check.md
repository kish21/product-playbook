...
3. **Table-stakes drift:** re-read `#Scope`'s table-stakes list. An item marked **in-scope now** that was
...
6. **Agent instructions that are ABSENT, before any check for rot.** A filled spine and **no**

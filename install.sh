...
echo "  ✓ companions → ${SUPPORT} (PRINCIPLES.md · MECHANISMS.md · MECHANISMS-ON-DEMAND.md · LESSONS.md · CASE-FILES-BUILD.md · STATE-MODEL.md · VISION.md · PRODUCT.md · session_cost.py)"
